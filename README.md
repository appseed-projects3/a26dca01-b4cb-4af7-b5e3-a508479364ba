...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-29 14:13`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a26dca01-b4cb-4af7-b5e3-a508479364ba.git
$ cd a26dca01-b4cb-4af7-b5e3-a508479364ba
```
